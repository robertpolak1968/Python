...
static int Encoder_init(pylame3_EncoderObject *self,
    ...
    if (self->outfp || self->gfp) {
        PyErr_SetString(PyExc_Exception, "__init__ zosta³o ju¿ wywo³ane");
        return -1;
    }
    self->outfp = outfp;
...
static PyObject *Encoder_encode(pylame3_EncoderObject *self, PyObject *args) {
    ...
    int mp3_bytes;
    if (!(self->outfp && self->gfp)) {
        PyErr_SetString(PyExc_Exception, "koder nie jest uruchomiony");
        return NULL;
    }
...
static PyMethodDef Encoder_methods[] = {
    { "encode", (PyCFunction)Encoder_encode, METH_VARARGS,
        "Koduje i zapisuje dane do pliku wyj¶ciowego." },
    { "close", (PyCFunction)Encoder_close, METH_NOARGS,
        "Zamyka plik wyj¶ciowy." },
    { NULL, NULL, 0, NULL }
};
...
static PyTypeObject pylame3_EncoderType = {
    ...
    "Mój pierwszy obiekt kodera.", /* tp_doc */
    0,                             /* tp_traverse */
    0,                             /* tp_clear */
    0,                             /* tp_richcompare */
    0,                             /* tp_weaklistoffset */
...
PyMODINIT_FUNC initpylame3() {
    ...
    m = Py_InitModule3("pylame3", pylame3_methods, "Mój trzeci modu³ LAME.");
